...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_rust_d485_rustbuffer_alloc(size, status).also {
                if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_rust_d485_rustbuffer_free(buf, status)
        }

        internal fun reserve(buf: RustBuffer.ByValue, additional: Int) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_rust_d485_rustbuffer_reserve(buf, additional, status)
        }
    }
...
internal interface _UniFFILib : Library {
    companion object {
        internal val INSTANCE: _UniFFILib by lazy {
            loadIndirect<_UniFFILib>(componentName = "rust")
            
            
        }
    }

    fun rust_d485_helloFromRust(
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_rust_d485_rustbuffer_alloc(size: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_rust_d485_rustbuffer_from_bytes(bytes: ForeignBytes.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_rust_d485_rustbuffer_free(buf: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_rust_d485_rustbuffer_reserve(buf: RustBuffer.ByValue,additional: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
fun helloFromRust(): String {
    return FfiConverterString.lift(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.rust_d485_helloFromRust( _status)
})
}
